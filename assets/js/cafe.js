...
if (cafein) {
  cafein.addEventListener("click", () => {
    if (sessionStorage.getItem("cafe") !== "true") {
      ...
      alert(
        `Aucun cadavre ne m'empêchera de récuperer ce qui me revient de droit.`
      );
    } else {
...
let dizaine = sessionStorage.getItem("dizaine")
  ? parseInt(sessionStorage.getItem("dizaine"))
  : 5;
let unites = sessionStorage.getItem("unites")
  ? parseInt(sessionStorage.getItem("unites"))
  : 9;
  ...
  setInterval(function () {
    ...
    if (unites == -1) {
      ...
      window.location.href =
        "https://img.freepik.com/vecteurs-libre/game-over-effet-glitch_225004-661.jpg?t=st=1729001229~exp=1729004829~hmac=ca5442e3bdf4d27878606bdc20748629afa9c20f7661ab45f4a5c3d2f664dc8c&w=1380";
    }
